...
@WebServlet(value = { "/goods/search", "/goods/search.json", "/goods/append", "/goods/list.json", "/goods/total",
		"/goods/list", "/goods/delete", "/goods/insert", "/goods/update", "/goods/read" })
public class GoodsController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		case "/goods/list.json": // http://localhost:8080/goods/list.json?page=1&query=
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		case "/goods/insert":
			MultipartRequest multi = new MultipartRequest(request, "c:" + path, 1024 * 1024 * 10, "UTF-8",
		...
		case "/goods/update":
			multi = new MultipartRequest(request, "c:" + path, 1024 * 1024 * 10, "UTF-8",
					new DefaultFileRenamePolicy());
